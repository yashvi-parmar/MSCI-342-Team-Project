...
<ThemeProvider theme={theme}>
    <Grid>
      <NavbarTop></NavbarTop>
      <Grid style={{
        padding: '10vh', color: 'white', display: 'flex', paddingBottom: '0vh',
        flexDirection: 'column', flexBasis: '100%', flex: 1
      }}>
        <Grid >

          <h1 align="center" style={{
            justifyContent: 'center', alignContent: 'center', fontFamily: 'Oswald',
            letterSpacing: '0.05rem', fontSize: '5vh', marginTop: '-1vh'
          }}>Welcome {profile.length > 0 ? profile[0].firstName : ''} {profile.length > 0 ? profile[0].lastName : ''}! </h1>
